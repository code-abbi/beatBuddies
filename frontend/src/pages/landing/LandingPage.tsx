...
const FeatureCard = ({ title, description, icon }: { title: string; description: string; icon: React.ReactNode }) => (
    <motion.div
        ...
        className='bg-card/50 p-8 rounded-2xl border border-border text-center flex flex-col items-center shadow-lg h-full glass-effect transition-all duration-300 hover:border-primary/50 hover:-translate-y-2'
    >
        <div className='mb-4 p-3 bg-gradient-to-br from-primary to-secondary text-primary-foreground rounded-full shadow-lg'>
            {icon}
        </div>
...
const StepItem = ({ number, title, description }: { number: string; title: string; description: string }) => (
    <div className='step-ladder-item'>
        ...
        >
            <h3 className='text-2xl font-bold mb-2 bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text'>{title}</h3>
            <p className='text-muted-foreground'>{description}</p>
        </motion.div>
    </div>
);
    ...
    return (
        <div className='bg-background text-foreground min-h-screen relative overflow-hidden'>
            ...
            <div className='relative z-10'>
                {/* Header */}
                <header className='p-4 sm:p-6 flex justify-between items-center sticky top-0 bg-background/80 backdrop-blur-lg z-50 border-b border-border'>
                    <div className='flex items-center gap-3'>
                        ...
                        <h1 className='text-2xl sm:text-3xl font-bold tracking-wider'>
                            Beat<span className='bg-gradient-to-r from-primary to-secondary text-transparent bg-clip-text'>Buddies</span>
                        </h1>
                    </div>
                    <div className='flex items-center gap-4'>
                        {isSignedIn ? (
                            <>
                                <span className='text-sm hidden md:block text-muted-foreground'>Welcome, {user?.firstName}</span>
                ...
                <section className='text-center px-6 py-28 sm:py-40'>
                    ...
                    >
                        <h2 className='text-5xl sm:text-7xl font-extrabold mb-6 leading-tight bg-gradient-to-r from-foreground via-primary to-secondary text-transparent bg-clip-text'>
                        ...
                        <Link to={isSignedIn ? "/home" : "/sign-in"}>
                            <Button size='lg' className='bg-gradient-to-r from-primary to-secondary text-primary-foreground font-bold text-lg px-10 py-7 shadow-lg transform hover:scale-105 transition-transform duration-200 rounded-full'>
                ...
                <section className='px-6 py-24 sm:py-32 bg-background/50'>
                    <div className='max-w-7xl mx-auto'>
                        <h2 className='text-4xl sm:text-5xl font-bold text-center mb-16 bg-gradient-to-r from-foreground to-primary text-transparent bg-clip-text'>
                ...
                <section className='px-6 py-20 sm:py-28 bg-background/50'>
                    <div className='max-w-3xl mx-auto relative z-10'>
                        <h2 className='text-3xl sm:text-4xl font-bold text-center mb-16 bg-gradient-to-r from-foreground to-secondary text-transparent bg-clip-text'>
                ...
                <section className='px-6 py-20 bg-background/50'>
                    <div className='max-w-6xl mx-auto'>
                        <h2 className='text-3xl sm:text-4xl font-bold text-center mb-12 bg-gradient-to-r from-foreground to-primary text-transparent bg-clip-text'>
                ...
                {/* Final CTA Section */}
                <section className='text-center px-6 py-28 sm:py-40 bg-background/50'>
                    <motion.div
                    ...
                    >
                        <h2 className='text-5xl sm:text-6xl font-extrabold mb-6 leading-tight bg-gradient-to-r from-foreground via-primary to-secondary text-transparent bg-clip-text'>
                ...
                {/* Footer */}
                <footer className='p-6 text-center text-muted-foreground text-sm mt-20 border-t border-border bg-background/80'>
